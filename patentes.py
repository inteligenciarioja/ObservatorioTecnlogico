...
def incluirBD(df) :
    ...
    for i in range(1, df.shape[0]) :
        ...
        for j in range(2,len(row)) :
            ...
            querystring = """INSERT INTO exampledb.PUBLICADAS (Provincia, SubsectorTec, NPublicadas, Year, lastupdate) VALUES (""" + lista + """);"""
            print(querystring)
...
def limpiarBD() :
    dbconnection = MySQLdb.connect(host='localhost',db='exampledb',
                              user='exampleuser', passwd='pimylifeup')
    querystringlimp = "DELETE FROM exampledb.PUBLICADAS"
    c = dbconnection.cursor()
...
limpiarBD()  
# CREATE TABLE PUBLICADAS(Provincia varchar(30), SubsectorTec varchar(30), NPublicadas varchar(30), Year varchar(30), lastupdate varchar(30));
...
df = dfs[0]
row = []
with open ('PUBLICADAS.csv', mode = 'a') as employee_file:

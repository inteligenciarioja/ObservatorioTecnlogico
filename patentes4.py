...
def incluirBD(df, year) :
    # CREATE TABLE SOLNACHAB(CCAA varchar(30), Solicitudes varchar(30), VarAnual varchar(30), PorcSobreTotalES varchar(30), Nhabitantes varchar(30), PorcHabitantesfrentetotalES varchar(30),RatioSolMillonHab varchar(30), DesviacionMedida varchar(30),Year varchar(30));
    header = df.iloc[0]
    ...
    for i in range(1, df.shape[0]) :
        ...
        strauxfinal = "'"+straux+"'"
        querystring = ("""INSERT INTO exampledb.SOLNACHAB"""
...
def limpiarBD() :
    dbconnection = MySQLdb.connect(host='localhost',db='exampledb',
                              user='exampleuser', passwd='pimylifeup')
    querystringlimp = "DELETE FROM exampledb.SOLNACHAB"
    c = dbconnection.cursor()
...
with open ('SOLNACHAB.csv', mode = 'a') as employee_file:

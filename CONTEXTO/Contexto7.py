...
# INDICADOR: Tasa de paro menores de 25 años
import requests
import json
import numpy
import time
...
with open ('Contexto7.csv',mode='w') as employee_file :
...
jsonurl = "http://servicios.ine.es/wstempus/js/es/DATOS_TABLA/4966?tip=AM&tv=18:454&tv=349:16473&tv=70:8997&tv=70:8998&tv=70:8999&tv=70:9000&tv=70:9001&tv=70:9002&tv=70:9003&tv=70:9004&tv=70:9005&tv=70:9006&tv=70:9007&tv=70:9008&tv=70:9009&tv=70:9010&tv=70:9011&tv=70:9012&tv=70:9013&tv=70:9015&tv=70:8995&tv=357:10568&tv=3:283910"
...
for j in range (0,len(rango)) :
    ...
    with open('Contexto7.csv',mode='a') as employee_file :
        employee_writer = csv.writer(employee_file, delimiter=';',quoting = csv.QUOTE_MINIMAL)

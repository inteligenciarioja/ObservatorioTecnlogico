...
select1.select_by_visible_text('4. Patentes Vía PCT (Solicitud Internacional de Patente)')
...
df = dfs[0]
row = []
with open ('SOL_PCT.csv', mode = 'a') as employee_file:
